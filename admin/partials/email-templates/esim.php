                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#525252;">
                                                <p>Scan the QR Code below or manully input SM-DP+Address and activation code to install</p>
                                            </div>
                                     ...
                                     <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
											...
											<img src="https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl={{activation_url}}&choe=UTF-8" title="Link to Google.com" />
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;word-break:break-word;">
                                        	 <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#525252;">
                                               ...
                                               <p style="text-align: center;">{{simdp_address}}</p>
                                            </div>
                                        ...
                                        <td align="left" style="font-size:0px;word-break:break-word;">
                                        	 <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#525252;">
                                           	...
                                           	<div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;line-height:16px;text-align:left;color:#a2a2a2;">
                                               <p style="text-align: center;">{{activation_code}}</p>
                                            </div>
                                        ...
                                        <td align="left" style="font-size:0px;word-break:break-word;">
                                        	 <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#525252;">
                                           	...
                                           	<div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;line-height:16px;text-align:left;color:#a2a2a2;">
                                               <p style="text-align: center;">{{confirmation_code}}</p>
                                            </div>
